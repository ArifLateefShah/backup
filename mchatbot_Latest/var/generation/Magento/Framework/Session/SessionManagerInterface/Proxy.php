<?php
namespace Magento\Framework\Session\SessionManagerInterface;

/**
 * Proxy class for @see \Magento\Framework\Session\SessionManagerInterface
 */
class Proxy implements \Magento\Framework\Session\SessionManagerInterface, \Magento\Framework\ObjectManager\NoninterceptableInterface
{
    /**
     ...
     * @param bool $shared
     */
    public function __construct(\Magento\Framework\ObjectManagerInterface $objectManager, $instanceName = '\\Magento\\Framework\\Session\\SessionManagerInterface', $shared = true)
    {
